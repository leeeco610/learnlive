/**
 * Zepto timeTo
 * The plugin Base on jquery.time-to.js
...
(function(factory) {
    ...
    $.dataCache = function() {
        function getData(cache, name) {
            return typeof name === 'undefined'?cache:cache[name];
        }
    ...
    var methods = {
        start: function(sec) {
            ...
            if(sec) {
                ...
                // save start time
                this.dataCache('ttStartTime', $.now());
                this.dataCache('intervalId', intervalId);
            }
        },
        ...
        stop: function() {
            ...
            if(data.intervalId) {
                ...
                this.dataCache('intervalId', null);
            }
            return data;
        },
    ...
    function init(sec, force) {
        ...
        if(isInterval || force) {
            ...
            this.dataCache('intervalId', data.intervalId);
        }
    }
